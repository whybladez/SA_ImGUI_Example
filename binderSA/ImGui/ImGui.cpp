...
/*
 ...
 - Dear ImGui is an implementation of the IMGUI paradigm (immediate-mode graphical user interface_state, a term coined by Casey Muratori).
...
// [SECTION] LOGGING/CAPTURING
//-----------------------------------------------------------------------------
// All text output from the interface_state can be captured into tty/file/clipboard.
