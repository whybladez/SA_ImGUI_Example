...
namespace ImGui
{
    ...
    // Logging/Capture
    // - All text output from the interface_state can be captured into tty/file/clipboard. By default, tree nodes are automatically opened during logging.
...
// - You want to manipulate the open/close state of a particular sub-tree in your interface_state (tree node uses Int 0/1 to store their state).
