...
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable: 4251) // class 'xxx' needs to have dll-interface_state to be used by clients of struct 'xxx' // when IMGUI_API is set to__declspec(dllexport)
#endif
